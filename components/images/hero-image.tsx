export function HeroImage() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 800 400" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="400" cy="200" r="150" fill="#E6E6FA" fillOpacity="0.6" />
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="350" cy="180" r="15" fill="#000080" />
      <circle cx="450" cy="180" r="15" fill="#000080" />
      <path
        ...
        strokeLinecap="round"
      />
      <text x="400" y="350" fontFamily="Arial" fontSize="24" fill="#000080" textAnchor="middle">
